...
int main(int argc, char** argv)
{
    ...
    GameObject* oCircle = new GameObject(30, 100, 10, fDirectionX, fDirectionY);
    GameObject* rect = new GameObject(450, 200, 100, 100);
    GameObject* oCanon = new GameObject(310, 410, 50, 20);
    GameObject* oWallLeft = new GameObject(-10, 0, 480, 10);
    GameObject* oWallRight = new GameObject(640, 0, 480, 10);
    GameObject* oWallTop = new GameObject(0, -10, 10, 630);
